...
private fun LoginScreen(
    ...
    Column(
        ...
        Text("ClarityPay", style = MaterialTheme.typography.headlineLarge)
        Text(
            "Controla tu dinero con una vista simple y clara.",
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(modifier = Modifier.padding(20.dp)) {
                ...
                Spacer(modifier = Modifier.height(12.dp))
                InfoMessageCard("Demo: demo@claritypay.app / 123456")
